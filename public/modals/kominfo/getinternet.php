...
$sql = "SELECT a.nmaKecamatan, c.ta, b.jmlDesaterlayani, b.jmlDesabelumterlayani FROM kecamatans as a, internetDetails as b, internetMasters as c";
$sql = $sql . " WHERE a.id = b.kecamatan_id and b.internetMaster_id = c.id and c.id = " . $q;
