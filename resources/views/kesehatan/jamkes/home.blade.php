...
<div class="container">
  ...
  <div class="collapse" id="collapseExample">
    <form class="form-group" id="formrekap" action="/kesehatan/jamkes/store" method="post">
    <div class="card">
      <div class="card-header">
        <div class="row">
      ...
      <div class="card-body">
            <table class="table table-striped table-hover">
              ...
              <?php
                $nomor = 1;
                foreach ($dataPuskesmas as $dataK) {
                    ?>
                  <tr>
                    <td>{{$nomor}}</td>
                    <td>{{$dataK->nmaPuskesmas}}</td>
                    <td>
                      <input type="number" id="jmlPeserta{{$nomor}}" class="form-control" name="jmlPeserta{{$nomor}}" value="0" readonly>
                    </td>
                    <td>
              ...
              <?php
               ...
               <tr>
                 ...
                 <td><b>Total</b></td>
                 <td>
                   <input type="number" id="totalPeserta" class="form-control" name="totalPeserta" value="0" readonly>
                 </td>
                 <td>
