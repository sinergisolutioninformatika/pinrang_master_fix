...
<div class="container">
          ...
          <table class="table table-striped" id="kepalaX">
            ...
            <?php
              ...
              foreach ($dataMaster as $dataM) {
                  ?>
              <form action="/kesehatan/giziburuk/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                <tr>
                  <input type="hidden" name="KasusMaster{{$dataM->id}}" value="">
                  <td>{{$nomor}}</td>
                  ...
                  <td>
                    ...
                    <a href="/kesehatan/giziburuk/edit/{{$dataM->id}}"><img src="/pics/edit.png" alt=""></a>
  ...
  <div class="collapse show" id="collapseExample">
    <form class="form-group" id="formrekap" action="/kesehatan/giziburuk/update/{{$kodeEdit}}" method="post">
    <div class="card">
      <div class="card-header">
        <div class="row">
              ...
              <?php
                ...
                foreach ($dataDetail as $dataD) {
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" id="jmlKasus{{$nomor}}" class="form-control" name="jmlKasus{{$nomor}}" value="{{$dataD->jmlKasus}}">
                    </td>
                    <td>
                      <input type="number" id="jmlPerawatan{{$nomor}}" class="form-control" name="jmlPerawatan{{$nomor}}" value="{{$dataD->jmlPerawatan}}">
                    </td>
                  </tr>
              <?php
                $nomor ++;
               ...
               <tr>
                 ...
                 <td><b>Total</b></td>
                 <td>
                   <input type="number" id="totalKasus" class="form-control" name="totalKasus" value="{{$dataE->totalKasus}}" readonly>
                 </td>
                 <td>
                   <input type="number" id="totalPerawatan" class="form-control" name="totalPerawatan" value="{{$dataE->totalPerawatan}}" readonly>
                 </td>
               </tr>
               {{csrf_field()}}
            </table>
  ...
  function showUser(str) {
      if (str == "") {
          ...
          xmlhttp.open("GET","/modals/kesehatan/getgiziburuk.php?q="+str,true);
          xmlhttp.send();
      }
  }
  </script>
     ...
     $(document).ready(function() {
       ...
       <?php
         ...
         foreach ($dataPuskesmas as $pus) {
           ...
           $("#jmlKasus{{$nopu}}").keyup(function() {
             ...
             <?php
               ...
               foreach ($dataPuskesmas as $pk){ ?>
                 ksd = ksd + Number($("#jmlKasus{{$nojk}}").val());
             <?php
               $nojk ++;
              }
             ?>
           ...
           $("#jmlPerawatan{{$nopu}}").keyup(function() {
             var ksd = 0;
             var kk = 0;
             var pkk = 0;
             <?php
               $nojk = 1;
               foreach ($dataPuskesmas as $pk){ ?>
                 ksd = ksd + Number($("#jmlPerawatan{{$nojk}}").val());
             <?php
               $nojk ++;
              }
             ?>
             $("#totalPerawatan").val(ksd);
           });
           $("#jmlKasus{{$nopu}}").change(function() {
             var ksd = 0;
             var kk = 0;
             var pkk = 0;
             <?php
           ...
           $("#jmlPerawatan{{$nopu}}").change(function() {
             var ksd = 0;
             var kk = 0;
             var pkk = 0;
             <?php
