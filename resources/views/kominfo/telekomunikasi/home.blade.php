...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/kominfo/telekomunikasi/store" method="post">
                ...
                <?php
                  ...
                  foreach ($dataKecamatan as $dataK) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlBTS{{$nomor}}" class="form-control" name="jmlBTS{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td>
                     <input type="number" id="totalBTS" class="form-control" name="totalBTS" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
