 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/kominfo/telekomunikasi/update/{{$kodeEdit}}" method="post">
                ...
                <?php
                  ...
                  foreach ($dataDetail as $dataD) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlDesabelumterlayani{{$nomor}}" class="form-control" name="jmlDesabelumterlayani{{$nomor}}" value="{{$dataD->jmlDesabelumterlayani}}">
                      </td>
                      <td>
                        <input type="number" id="jmlBTS{{$nomor}}" class="form-control" name="jmlBTS{{$nomor}}" value="{{$dataD->jmlBTS}}">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td>
                     <input type="number" id="totalDesabelumterlayani" class="form-control" name="totalDesabelumterlayani" value="{{$dataE->totalDesabelumterlayani}}" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalBTS" class="form-control" name="totalBTS" value="{{$dataE->totalBTS}}" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
