...
<div class="container">
              ...
              <form action="/pemodal/penerbitanizin/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                <tr>
                  ...
                  <td>
                    ...
                    <a href="/pemodal/penerbitanizin/edit/{{$dataM->id}}"><img src="/pics/edit.png" alt=""></a>
  ...
  <div class="collapse show" id="collapseExample">
    <form class="form-group" id="formrekap" action="/pemodal/penerbitanizin/update/{{$kodeEdit}}" method="post">
            ...
            <table class="table table-striped table-hover">
              ...
              <?php
                ...
                foreach ($dataDetail as $dataD) {
                  ...
                  <tr>
                    <td>{{$nomor}}</td>
                    <td>{{$dataD->nmaBidang}}</td>
                    <td>
                      <input type="number" id="jmlPenerbitan{{$nomor}}" class="form-control" name="jmlPenerbitan{{$nomor}}" value="{{$dataD->jmlPenerbitan}}">
                    </td>
                    <td>
                      <input type="number" id="jmlRetribusi{{$nomor}}" class="form-control" name="jmlRetribusi{{$nomor}}" value="{{$dataD->jmlRetribusi}}">
                    </td>
                  </tr>
              <?php
                $nomor ++;
               ...
               <tr>
                 ...
                 <td><b>Total</b></td>
                 <td>
                   <input type="number" id="totalPenerbitan" class="form-control" name="totalPenerbitan" value="{{$dataE->totalPenerbitan}}" readonly>
                 </td>
                 <td>
                   <input type="number" id="totalRetribusi" class="form-control" name="totalRetribusi" value="{{$dataE->totalRetribusi}}" readonly>
                 </td>
               </tr>
               {{csrf_field()}}
            </table>
  ...
  function showUser(str) {
      if (str == "") {
          ...
          xmlhttp.open("GET","/modals/pemodal/getpenerbitanizin.php?q="+str,true);
          xmlhttp.send();
      }
  }
  </script>
