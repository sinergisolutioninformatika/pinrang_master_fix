...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perhubungan/lakalantas/store" method="post">
            <div class="form-group row">
                <label for="jmlKejadian" class="col-md-4 col-form-label text-md-right">Jumlah Kejadian</label>
                <div class="col-md-6">
                    <input id="jmlKejadian" type="number" class="form-control" name="jmlKejadian" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="Meninggal" type="number" class="form-control" name="Meninggal" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Lukaberat" class="col-md-4 col-form-label text-md-right">Luka Berat</label>
                <div class="col-md-6">
                    <input id="Lukaberat" type="number" class="form-control" name="Lukaberat" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Lukaringan" class="col-md-4 col-form-label text-md-right">Luka Ringan</label>
                <div class="col-md-6">
                    <input id="Lukaringan" type="number" class="form-control" name="Lukaringan" value="0" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
