...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perhubungan/ujikendaraan/store" method="post">
            <div class="form-group row">
                <label for="Mobilpenumpang" class="col-md-4 col-form-label text-md-right">Mobil Penumpang</label>
                <div class="col-md-6">
                    <input id="Mobilpenumpang" type="number" class="form-control" name="Mobilpenumpang" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Mobilbarang" class="col-md-4 col-form-label text-md-right">Mobil Barang</label>
                <div class="col-md-6">
                    <input id="Mobilbarang" type="number" class="form-control" name="Mobilbarang" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Mobilkhusus" class="col-md-4 col-form-label text-md-right">Mobil Khusus</label>
                <div class="col-md-6">
                    <input id="Mobilkhusus" type="number" class="form-control" name="Mobilkhusus" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Keretagandeng" class="col-md-4 col-form-label text-md-right">Kereta Gandengan</label>
                <div class="col-md-6">
                    <input id="Keretagandeng" type="number" class="form-control" name="Keretagandeng" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Keretatempelan" class="col-md-4 col-form-label text-md-right">Kereta Tempelan</label>
                <div class="col-md-6">
                    <input id="Keretatempelan" type="number" class="form-control" name="Keretatempelan" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
