 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perhubungan/fasjal/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="Apill" class="col-md-4 col-form-label text-md-right">APILL (Traffic Light)</label>
                <div class="col-md-6">
                    <input id="Apill" type="number" class="form-control" name="Apill" value="{{$dataE->Apill}}" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="Warning" type="number" class="form-control" name="Warning" value="{{$dataE->Warning}}" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
