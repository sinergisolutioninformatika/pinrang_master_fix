...
<div class="collapse show" id="collapseExample">
  <form class="form-group" id="formrekap" action="/kependudukan/penduduk/update/{{$kodeEdit}}" method="post">
      ...
      <div class="row">
          ...
          <div class="col-md-8">
            <select class="form-control" id="bln" style="max-width:200px" name="bln">
              ...
              for ($x = 1; $x <= 12; $x++) {
                 if ($dataE->bln == $x) {
                  echo "<option value=" . $x . " selected>" . $namabulan[$x] . "</option>";
                } else {
                  echo "<option value=" . $x . ">" . $namabulan[$x] . "</option>";
                }
              }
               ?>
            </select>
          ...
          <?php
            ...
            foreach ($dataDetail as $dataD) {
              ...
              <tr>
                ...
                <td>
                  <input type="number" id="jmlPenduduk{{$nomor}}" class="form-control" name="jmlPenduduk{{$nomor}}" value="{{$dataD->jmlPenduduk}}" readonly>
                </td>
                <td>
                  <input type="number" id="jmlPendLaki{{$nomor}}" class="form-control" name="jmlPendLaki{{$nomor}}" value="{{$dataD->jmlPendLaki}}">
                </td>
                <td>
                  <input type="number" id="jmlPendPerempuan{{$nomor}}" class="form-control" name="jmlPendPerempuan{{$nomor}}" value="{{$dataD->jmlPendPerempuan}}">
                </td>
                <td>
                  <input type="number" id="jmlWKTP{{$nomor}}" class="form-control" name="jmlWKTP{{$nomor}}" value="{{$dataD->jmlWKTP}}" readonly>
                </td>
                <td>
                  <input type="number" id="jmlWKTPLaki{{$nomor}}" class="form-control" name="jmlWKTPLaki{{$nomor}}" value="{{$dataD->jmlWKTPLaki}}">
                </td>
                <td>
                  <input type="number" id="jmlWKTPPerempuan{{$nomor}}" class="form-control" name="jmlWKTPPerempuan{{$nomor}}" value="{{$dataD->jmlWKTPPerempuan}}">
                </td>
                <td>
                  <input type="number" id="jmlCetak{{$nomor}}" class="form-control" name="jmlCetak{{$nomor}}" value="{{$dataD->jmlCetak}}">
                </td>
              </tr>
          <?php
            $nomor ++;
           ...
           <tr>
             ...
             <td><b>Total</b></td>
             <td>
               <input type="number" id="totalPenduduk" class="form-control" name="totalPenduduk" value="{{$dataE->totalPenduduk}}" readonly>
             </td>
             <td>
               <input type="number" id="totalPendLaki" class="form-control" name="totalPendLaki" value="{{$dataE->totalPendLaki}}" readonly>
             </td>
             <td>
               <input type="number" id="totalPendPerempuan" class="form-control" name="totalPendPerempuan" value="{{$dataE->totalPendPerempuan}}" readonly>
             </td>
             <td>
               <input type="number" id="totalWKTP" class="form-control" name="totalWKTP" value="{{$dataE->totalWKTP}}" readonly>
             </td>
             <td>
               <input type="number" id="totalWKTPLaki" class="form-control" name="totalWKTPLaki" value="{{$dataE->totalWKTPLaki}}" readonly>
             </td>
             <td>
               <input type="number" id="totalWKTPPerempuan" class="form-control" name="totalWKTPPerempuan" value="{{$dataE->totalWKTPPerempuan}}" readonly>
             </td>
             <td>
               <input type="number" id="totalCetak" class="form-control" name="totalCetak" value="{{$dataE->totalCetak}}" readonly>
             </td>
           </tr>
           {{csrf_field()}}
        </table>
...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","/modals/kependudukan/getPenduduk.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
