...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/unjukrasa/store" method="post">
            <div class="form-group row">
                <label for="jmlPolitik" class="col-md-4 col-form-label text-md-right">Kasus Politik</label>
                <div class="col-md-6">
                    <input id="jmlPolitik" type="number" class="form-control" name="jmlPolitik" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlEkonomi" class="col-md-4 col-form-label text-md-right">Kasus Ekonomi</label>
                <div class="col-md-6">
                    <input id="jmlEkonomi" type="number" class="form-control" name="jmlEkonomi" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlLainnya" type="number" class="form-control" name="jmlLainnya" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlKasus" type="number" class="form-control" name="jmlKasus" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
