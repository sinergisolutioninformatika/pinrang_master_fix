              ...
              <?php
                ...
                <form action="/satpolpp/pelanggaranK3/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    ...
                    <td nowrap>
                      <a href="/satpolpp/pelanggaranK3/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/pelanggaranK3/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="jmlKasus" class="col-md-4 col-form-label text-md-right">Jumlah Kasus Pelanggaran</label>
                <div class="col-md-6">
                    <input id="jmlKasus" type="number" class="form-control" name="jmlKasus" value="{{$dataE->jmlKasus}}" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
