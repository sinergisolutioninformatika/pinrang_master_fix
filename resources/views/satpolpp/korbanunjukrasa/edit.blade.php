              ...
              <?php
                ...
                <form action="/satpolpp/korbanunjukrasa/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    ...
                    <td nowrap>
                      <a href="/satpolpp/korbanunjukrasa/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/korbanunjukrasa/update/{{$kodeEdit}}" method="post">
