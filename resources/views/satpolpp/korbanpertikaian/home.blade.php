...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/korbanpertikaian/store" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlKorban" type="number" class="form-control" name="jmlKorban" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
