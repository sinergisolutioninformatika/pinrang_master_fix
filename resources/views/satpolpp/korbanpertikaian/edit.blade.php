@extends('layouts.app')
@section('title','Data Korban Pertikaian Antar Warga')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Korban Pertikaian Antar Warga</li>
      </ol>
    </nav>
</div>
@endsection
...
<div class="container">
    <div class="card">
      <div class="card-header">
        <b>Data Korban Pertikaian Antar Warga</b>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
          <div id="home" class="container tab-pane active"><br>
              <canvas id="korbanpertikaian" width="800px" height="400px"></canvas>
          </div>
          <div id="menu1" class="container tab-pane"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Korban Pertikaian Antar Warga</caption>
                <thead>
                  <tr>
                    <th>No.</th>
                    <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/satpolpp/korbanpertikaian/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="korbanpertikaian{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td nowrap>
                      <a href="/satpolpp/korbanpertikaian/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/korbanpertikaian/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="jmlMeninggal" class="col-md-4 col-form-label text-md-right">Korban Meninggal</label>
                <div class="col-md-6">
                    <input id="jmlMeninggal" type="number" class="form-control" name="jmlMeninggal" value="{{$dataE->jmlMeninggal}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlLuka" class="col-md-4 col-form-label text-md-right">Korban Luka-luka</label>
                <div class="col-md-6">
                    <input id="jmlLuka" type="number" class="form-control" name="jmlLuka" value="{{$dataE->jmlLuka}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlKorban" class="col-md-4 col-form-label text-md-right">Jumlah Korban</label>
                <div class="col-md-6">
                    <input id="jmlKorban" type="number" class="form-control" name="jmlKorban" value="{{$dataE->jmlKorban}}" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
...
<script>
var ctx = document.getElementById("korbanpertikaian");
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Grafik Data Korban Pertikaian Antar Warga'
       },
    animation: {
