...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/saranakeamanan/store" method="post">
            <div class="form-group row">
                <label for="jmlPoskeamanan" class="col-md-4 col-form-label text-md-right">Pos Keamanan</label>
                <div class="col-md-6">
                    <input id="jmlPoskeamanan" type="number" class="form-control" name="jmlPoskeamanan" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPoskamling" class="col-md-4 col-form-label text-md-right">Pos Kamling</label>
                <div class="col-md-6">
                    <input id="jmlPoskamling" type="number" class="form-control" name="jmlPoskamling" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlSarana" type="number" class="form-control" name="jmlSarana" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
