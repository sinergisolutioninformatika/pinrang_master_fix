              ...
              <?php
                ...
                <form action="/satpolpp/kendaraanoperasional/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    ...
                    <td nowrap>
                      <a href="/satpolpp/kendaraanoperasional/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/satpolpp/kendaraanoperasional/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="jmlRoda2" class="col-md-4 col-form-label text-md-right">Roda 2</label>
                <div class="col-md-6">
                    <input id="jmlRoda2" type="number" class="form-control" name="jmlRoda2" value="{{$dataE->jmlRoda2}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlRoda4" class="col-md-4 col-form-label text-md-right">Roda 4</label>
                <div class="col-md-6">
                    <input id="jmlRoda4" type="number" class="form-control" name="jmlRoda4" value="{{$dataE->jmlRoda4}}" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
