...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/kesbangpol/lsm/store" method="post">
            <div class="form-group row">
                <label for="jmlLokalterdaftar" class="col-md-4 col-form-label text-md-right">LSM Lokal Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlLokalterdaftar" type="number" class="form-control" name="jmlLokalterdaftar" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlLokaltidakterdaftar" class="col-md-4 col-form-label text-md-right">LSM Lokal Tidak Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlLokaltidakterdaftar" type="number" class="form-control" name="jmlLokaltidakterdaftar" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlNasionalterdaftar" class="col-md-4 col-form-label text-md-right">LSM Nasional Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlNasionalterdaftar" type="number" class="form-control" name="jmlNasionalterdaftar" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlNasionaltidakterdaftar" class="col-md-4 col-form-label text-md-right">LSM Nasional Tidak Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlNasionaltidakterdaftar" type="number" class="form-control" name="jmlNasionaltidakterdaftar" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlInterterdaftar" class="col-md-4 col-form-label text-md-right">LSM Internasional Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlInterterdaftar" type="number" class="form-control" name="jmlInterterdaftar" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlIntertidakterdaftar" class="col-md-4 col-form-label text-md-right">LSM Internasional Tidak Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlIntertidakterdaftar" type="number" class="form-control" name="jmlIntertidakterdaftar" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlLSM" type="number" class="form-control" name="jmlLSM" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
