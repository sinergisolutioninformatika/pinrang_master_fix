        ...
        <div class="card-body">
          <form class="form-group" action="/kesbangpol/lsm/store" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlLokaltidakterdaftar" type="number" class="form-control" name="jmlLokaltidakterdaftar" value="0">
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlNasionalterdaftar" class="col-md-4 col-form-label text-md-right">LSM Nasional Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlNasionalterdaftar" type="number" class="form-control" name="jmlNasionalterdaftar" value="0">
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlNasionaltidakterdaftar" class="col-md-4 col-form-label text-md-right">LSM Nasional Tidak Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlNasionaltidakterdaftar" type="number" class="form-control" name="jmlNasionaltidakterdaftar" value="0">
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlInterterdaftar" class="col-md-4 col-form-label text-md-right">LSM Internasional Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlInterterdaftar" type="number" class="form-control" name="jmlInterterdaftar" value="0">
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlIntertidakterdaftar" class="col-md-4 col-form-label text-md-right">LSM Internasional Tidak Terdaftar</label>
                <div class="col-md-6">
                    <input id="jmlIntertidakterdaftar" type="number" class="form-control" name="jmlIntertidakterdaftar" value="0">
                </div>
            </div>
            <hr>
            <div class="form-group row">
