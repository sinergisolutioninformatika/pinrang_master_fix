@extends('layouts.app')
@section('title','Data Produktivitas dan Areal Perkebunan (Panili)')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Produktivitas dan Areal Perkebunan (Panili)</li>
      </ol>
    </nav>
</div>
@endsection
...
<div class="container">
    <div class="card">
      <div class="card-header">
        <b>Data Produktivitas dan Areal Perkebunan (Panili)</b>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
          ...
          <div id="menu2" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Produktivitas dan Areal Perkebunan (Panili)</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/perkebunan/kebunPanili/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="kebunPaniliMaster{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td nowrap>
                      <a href="/perkebunan/kebunPanili/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perkebunan/kebunPanili/store" method="post">
 ...
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Graifik Produktivitas dan Areal Perkebunan (Panili)'
       },
    animation: {
