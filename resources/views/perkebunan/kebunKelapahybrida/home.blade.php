@extends('layouts.app')
@section('title','Data Produktivitas dan Areal Perkebunan (Kelapa Hybrida)')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Produktivitas dan Areal Perkebunan (Kelapa Hybrida)</li>
      </ol>
    </nav>
</div>
@endsection
...
<div class="container">
    <div class="card">
      <div class="card-header">
        <b>Data Produktivitas dan Areal Perkebunan (Kelapa Hybrida)</b>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
          ...
          <div id="menu2" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Produktivitas dan Areal Perkebunan (Kelapa Hybrida)</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/perkebunan/kebunKelapahybrida/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="kebunKelapahybridaMaster{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td nowrap>
                      <a href="/perkebunan/kebunKelapahybrida/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perkebunan/kebunKelapahybrida/store" method="post">
            <div class="form-group row">
                <label for="Areal" class="col-md-4 col-form-label text-md-right">Luas Areal (Ha)</label>
                <div class="col-md-6">
                    <input id="Areal" type="number" class="form-control" name="Areal" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Petani" class="col-md-4 col-form-label text-md-right">Jumlah Petani (KK)</label>
                <div class="col-md-6">
                    <input id="Petani" type="number" class="form-control" name="Petani" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Produksi" class="col-md-4 col-form-label text-md-right">Jumlah Produksi (ton)</label>
                <div class="col-md-6">
                    <input id="Produksi" type="number" class="form-control" name="Produksi" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Produktivitas" class="col-md-4 col-form-label text-md-right">Produktivitas (Kg/Ha)</label>
                <div class="col-md-6">
                    <input id="Produktivitas" type="number" class="form-control" name="Produktivitas" value="0" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
 ...
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Graifik Produktivitas dan Areal Perkebunan (Kelapa Hybrida)'
       },
    animation: {
