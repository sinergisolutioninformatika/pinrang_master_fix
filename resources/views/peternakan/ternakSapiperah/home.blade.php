@extends('layouts.app')
@section('title','Data Populasi Hewan Ternak (Sapi Perah)')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Populasi Hewan Ternak (Sapi Perah)</li>
      </ol>
    </nav>
</div>
@endsection
...
<div class="container">
    <div class="card">
      <div class="card-header">
        <b>Data Populasi Hewan Ternak (Sapi Perah)</b>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
          ...
          <div id="menu2" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Populasi Hewan Ternak (Sapi Perah)</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/peternakan/ternakSapiperah/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="ternakSapiperahMaster{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td nowrap>
                      <a href="/peternakan/ternakSapiperah/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/peternakan/ternakSapiperah/store" method="post">
 ...
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Grafik Populasi Hewan Ternak (Sapi Perah)'
       },
    animation: {
        ...
        <?php echo $katax; ?>
              ...
              options:{
                title: {
                       ...
                       position: 'top',
                       fontsize: 14,
                       text: 'Grafik Data Populasi Hewan Ternak (Sapi Perah)'
                   },
                animation: {
