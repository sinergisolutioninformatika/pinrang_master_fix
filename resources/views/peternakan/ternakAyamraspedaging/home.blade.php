@extends('layouts.app')
@section('title','Data Populasi Hewan Ternak (Ayam Ras Pedaging)')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Populasi Hewan Ternak (Ayam Ras Pedaging)</li>
      </ol>
    </nav>
</div>
@endsection
...
<div class="container">
    <div class="card">
      <div class="card-header">
        <b>Data Populasi Hewan Ternak (Ayam Ras Pedaging)</b>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
          ...
          <div id="menu2" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Populasi Hewan Ternak (Ayam Ras Pedaging)</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/peternakan/ternakAyamraspedaging/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="ternakAyamraspedagingMaster{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td nowrap>
                      <a href="/peternakan/ternakAyamraspedaging/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/peternakan/ternakAyamraspedaging/store" method="post">
            <div class="form-group row">
                <label for="Populasi" class="col-md-4 col-form-label text-md-right">Populasi</label>
                <div class="col-md-6">
                    <input id="Populasi" type="number" class="form-control" name="Populasi" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Kematian" class="col-md-4 col-form-label text-md-right">Jumlah Kematian</label>
                <div class="col-md-6">
                    <input id="Kematian" type="number" class="form-control" name="Kematian" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Kelahiran" class="col-md-4 col-form-label text-md-right">Jumlah Kelahiran</label>
                <div class="col-md-6">
                    <input id="Kelahiran" type="number" class="form-control" name="Kelahiran" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Masuk" class="col-md-4 col-form-label text-md-right">Ternak Masuk</label>
                <div class="col-md-6">
                    <input id="Masuk" type="number" class="form-control" name="Masuk" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Keluar" class="col-md-4 col-form-label text-md-right">Ternak Keluar</label>
                <div class="col-md-6">
                    <input id="Keluar" type="number" class="form-control" name="Keluar" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="RPH" type="number" class="form-control" name="RPH" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="NonRPH" class="col-md-4 col-form-label text-md-right">Pemotongan Non RPH</label>
                <div class="col-md-6">
                    <input id="NonRPH" type="number" class="form-control" name="NonRPH" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPotong" class="col-md-4 col-form-label text-md-right">Jumlah Pemotongan</label>
                <div class="col-md-6">
                    <input id="jmlPotong" type="number" class="form-control" name="jmlPotong" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
 ...
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Grafik Populasi Hewan Ternak (Ayam Ras Pedaging)'
       },
    animation: {
        ...
        <?php echo $katax; ?>
              ...
              options:{
                title: {
                       ...
                       position: 'top',
                       fontsize: 14,
                       text: 'Grafik Data Populasi Hewan Ternak (Ayam Ras Pedaging)'
                   },
                animation: {
