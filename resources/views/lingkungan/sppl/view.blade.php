...
<div class="container">
  ...
  <div class="collapse" id="collapseExample">
    <form class="form-group" id="formrekap" action="/lingkungan/sppl/store" method="post">
    <div class="card">
      <div class="card-header">
        <div class="row">
              ...
              <?php
                ...
                foreach ($dataKecamatan as $dataK) {
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" id="jmlSurat{{$nomor}}" class="form-control" name="jmlSurat{{$nomor}}" value="0">
                    </td>
                  </tr>
              <?php
                $nomor ++;
               ...
               <tr>
                 ...
                 <td><b>Total</b></td>
                 <td>
                   <input type="number" id="totalSurat" class="form-control" name="totalSurat" value="0" readonly>
                 </td>
               </tr>
               {{csrf_field()}}
            </table>
  ...
  function showUser(str) {
      if (str == "") {
          ...
          xmlhttp.open("GET","{{url('/lingkungan/sppl/detail')}}"+'/'+str,true);
          xmlhttp.send();
      }
  }
  </script>
