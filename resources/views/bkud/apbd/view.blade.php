...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkud/apbd/store" method="post">
            <div class="form-group row">
                <label for="jmlPAD" class="col-md-4 col-form-label text-md-right">Pendapatan Asli Daerah</label>
                <div class="col-md-6">
                    <input id="jmlPAD" type="number" class="form-control" name="jmlPAD" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlDanaperimbangan" class="col-md-4 col-form-label text-md-right">Dana Perimbangan</label>
                <div class="col-md-6">
                    <input id="jmlDanaperimbangan" type="number" class="form-control" name="jmlDanaperimbangan" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPendapatanlain" class="col-md-4 col-form-label text-md-right">Lain-lain Pendapatan Daerah yang sah</label>
                <div class="col-md-6">
                    <input id="jmlPendapatanlain" type="number" class="form-control" name="jmlPendapatanlain" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPendapatan" class="col-md-4 col-form-label text-md-right">Jumlah Pendapatan</label>
                <div class="col-md-6">
                    <input id="jmlPendapatan" type="number" class="form-control" name="jmlPendapatan" value="0" readonly>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlBelanjatidaklangsung" type="number" class="form-control" name="jmlBelanjatidaklangsung" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlBelanjalangsung" class="col-md-4 col-form-label text-md-right">Belanja Langsung</label>
                <div class="col-md-6">
                    <input id="jmlBelanjalangsung" type="number" class="form-control" name="jmlBelanjalangsung" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlBelanja" class="col-md-4 col-form-label text-md-right">Jumlah Belanja</label>
                <div class="col-md-6">
                    <input id="jmlBelanja" type="number" class="form-control" name="jmlBelanja" value="0" readonly>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlPembiayaanpenerimaan" type="number" class="form-control" name="jmlPembiayaanpenerimaan" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPembiayaanpengeluaran" class="col-md-4 col-form-label text-md-right">Pengeluaran Pembiayaan Daerah</label>
                <div class="col-md-6">
                    <input id="jmlPembiayaanpengeluaran" type="number" class="form-control" name="jmlPembiayaanpengeluaran" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPembiayaan" class="col-md-4 col-form-label text-md-right">Pembiayaan Neto</label>
                <div class="col-md-6">
                    <input id="jmlPembiayaan" type="number" class="form-control" name="jmlPembiayaan" value="0" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlSilpa" class="col-md-4 col-form-label text-md-right">Silpa</label>
                <div class="col-md-6">
                    <input id="jmlSilpa" type="number" class="form-control" name="jmlSilpa" value="0" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
 ...
 var myLineChart = new Chart(ctx, {
  ...
  options:{
    title: {
           ...
           position: 'top',
           fontsize: 14,
           text: 'Grafik Data Anggaran Pendapatan Belanja Daerah'
       },
    animation: {
