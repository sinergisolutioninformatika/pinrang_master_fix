...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/koperasi/koperasi/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  $nomor = 1;
                  foreach ($daftar_koperasi as $dataK) {
                      ?>
                    <tr>
                      <td>{{$nomor}}</td>
                      <td nowrap>{{$dataK->nmaKoperasi}}</td>
                      <td>
                        <input type="number" id="jmlKoperasi{{$nomor}}" class="form-control" name="jmlKoperasi{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                        <input type="number" id="jmlAktif{{$nomor}}" class="form-control" name="jmlAktif{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlTidakaktif{{$nomor}}" class="form-control" name="jmlTidakaktif{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalKoperasi" class="form-control" name="totalKoperasi" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalAktif" class="form-control" name="totalAktif" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalTidakaktif" class="form-control" name="totalTidakaktif" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
...
$(document).ready(function() {
  ...
  <?php
    $nopu = 1;
    foreach ($daftar_koperasi as $pus) {
   ?>
