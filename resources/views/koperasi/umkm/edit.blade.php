 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/koperasi/umkm/update/{{$kodeEdit}}" method="post">
                ...
                <?php
                  ...
                  foreach ($dataDetail as $dataD) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlUMKM{{$nomor}}" class="form-control" name="jmlUMKM{{$nomor}}" value="{{$dataD->jmlUMKM}}" readonly>
                      </td>
                      <td>
                        <input type="number" id="jmlPerdagangan{{$nomor}}" class="form-control" name="jmlPerdagangan{{$nomor}}" value="{{$dataD->jmlPerdagangan}}">
                      </td>
                      <td>
                        <input type="number" id="jmlIndustriPertanian{{$nomor}}" class="form-control" name="jmlIndustriPertanian{{$nomor}}" value="{{$dataD->jmlIndustriPertanian}}">
                      </td>
                      <td>
                        <input type="number" id="jmlIndustriNonPertanian{{$nomor}}" class="form-control" name="jmlIndustriNonPertanian{{$nomor}}" value="{{$dataD->jmlIndustriNonPertanian}}">
                      </td>
                      <td>
                        <input type="number" id="jmlAnekaJasa{{$nomor}}" class="form-control" name="jmlAnekaJasa{{$nomor}}" value="{{$dataD->jmlAnekaJasa}}">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalUMKM" class="form-control" name="totalUMKM" value="{{$dataE->totalUMKM}}" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPerdagangan" class="form-control" name="totalPerdagangan" value="{{$dataE->totalPerdagangan}}" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalIndustriPertanian" class="form-control" name="totalIndustriPertanian" value="{{$dataE->totalIndustriPertanian}}" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalIndustriNonPertanian" class="form-control" name="totalIndustriNonPertanian" value="{{$dataE->totalIndustriNonPertanian}}" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalAnekaJasa" class="form-control" name="totalAnekaJasa" value="{{$dataE->totalAnekaJasa}}" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
