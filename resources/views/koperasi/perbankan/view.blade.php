        ...
        <div class="card-body">
          <form class="form-group" action="/koperasi/perbankan/store" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlBank" type="number" class="form-control" name="jmlBank" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
