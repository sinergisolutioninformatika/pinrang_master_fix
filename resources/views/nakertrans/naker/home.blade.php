...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/nakertrans/naker/store" method="post">
                ...
                <?php
                  ...
                  foreach ($dataKecamatan as $dataK) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlPerusahaan{{$nomor}}" class="form-control" name="jmlPerusahaan{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlNaker{{$nomor}}" class="form-control" name="jmlNaker{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                        <input type="number" id="jmlNakerlaki{{$nomor}}" class="form-control" name="jmlNakerlaki{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlNakerperempuan{{$nomor}}" class="form-control" name="jmlNakerperempuan{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalPerusahaan" class="form-control" name="totalPerusahaan" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalNaker" class="form-control" name="totalNaker" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalNakerlaki" class="form-control" name="totalNakerlaki" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalNakerperempuan" class="form-control" name="totalNakerperempuan" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
