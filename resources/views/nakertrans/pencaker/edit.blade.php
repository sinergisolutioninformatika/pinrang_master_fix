 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/nakertrans/pencaker/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="pencakerLaki" class="col-md-4 col-form-label text-md-right">Pencari Kerja Laki-laki</label>
                <div class="col-md-6">
                    <input id="pencakerLaki" type="number" class="form-control" name="pencakerLaki" value="{{$dataE->pencakerLaki}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="pencakerPerempuan" class="col-md-4 col-form-label text-md-right">Pencari Kerja Perempuan</label>
                <div class="col-md-6">
                    <input id="pencakerPerempuan" type="number" class="form-control" name="pencakerPerempuan" value="{{$dataE->pencakerPerempuan}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlPencaker" class="col-md-4 col-form-label text-md-right">Jumlah Pencari Kerja</label>
                <div class="col-md-6">
                    <input id="jmlPencaker" type="number" class="form-control" name="jmlPencaker" value="{{$dataE->jmlPencaker}}" readonly>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="ditempatkanLaki" type="number" class="form-control" name="ditempatkanLaki" value="{{$dataE->ditempatkanLaki}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="ditempatkanPerempauan" class="col-md-4 col-form-label text-md-right">Ditempatkan Perempuan</label>
                <div class="col-md-6">
                    <input id="ditempatkanPerempuan" type="number" class="form-control" name="ditempatkanPerempuan" value="{{$dataE->ditempatkanPerempuan}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlDitempatkan" class="col-md-4 col-form-label text-md-right">Jumlah Ditempatkan</label>
                <div class="col-md-6">
                    <input id="jmlDitempatkan" type="number" class="form-control" name="jmlDitempatkan" value="{{$dataE->jmlDitempatkan}}" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
