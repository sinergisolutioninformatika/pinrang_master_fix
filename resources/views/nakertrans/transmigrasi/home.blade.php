...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/nakertrans/transmigrasi/store" method="post">
            <div class="form-group row">
                <label for="Lakilaki" class="col-md-4 col-form-label text-md-right">Jumlah Laki-laki</label>
                <div class="col-md-6">
                    <input id="Lakilaki" type="number" class="form-control" name="Lakilaki" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Perempuan" class="col-md-4 col-form-label text-md-right">Jumlah Perempuan</label>
                <div class="col-md-6">
                    <input id="Perempuan" type="number" class="form-control" name="Perempuan" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="Jumlah" class="col-md-4 col-form-label text-md-right">Jumlah Transmigran</label>
                <div class="col-md-6">
                    <input id="Jumlah" type="number" class="form-control" name="Jumlah" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
