 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pupr/drainase/update/{{$kodeEdit}}" method="post">
                ...
                <?php
                  ...
                  foreach ($dataDetail as $dataD) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlVol{{$nomor}}" class="form-control" name="jmlVol{{$nomor}}" value="{{$dataD->jmlVol}}">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalVol" class="form-control" name="totalVol" value="{{$dataE->totalVol}}" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
