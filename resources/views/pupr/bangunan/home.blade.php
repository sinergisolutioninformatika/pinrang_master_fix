...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Bangunan</li>
      </ol>
    </nav>
</div>
@endsection
        ...
        <div class="tab-content">
          ...
          <div id="menu1" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Bangunan</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pupr/bangunan/store" method="post">
