@extends('layouts.app')
@section('title','Data Jumlah Bangunan')
...
<div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Data Jumlah Bangunan</li>
      </ol>
    </nav>
</div>
@endsection
      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div id="home" class="container tab-pane active"><br>
              <canvas id="bangunan" width="800px" height="400px"></canvas>
          </div>
          <div id="menu1" class="container tab-pane fade"><br>
            <table class="table table-striped">
              <caption style="caption-side:top;">Data Jumlah Bangunan</caption>
              <tr>
                <thead>
                  <th>No.</th>
                  <th>Tahun</th>
              ...
              <?php
                ...
                foreach ($dataMaster as $dataM) {
                    ?>
                <form action="/pupr/bangunan/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="bangunanMaster{{$dataM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$dataM->ta}}</td>
                    ...
                    <td>
                      ...
                      <a href="/pupr/bangunan/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pupr/bangunan/update/{{$kodeEdit}}" method="post">
  ...
  function showUser(str) {
      if (str == "") {
          ...
          xmlhttp.open("GET","{{ url('pupr/bangunan/detail') }}"+'/'+str,true);
          xmlhttp.send();
      }
  }
  </script>
  ...
  <script>
  var ctx = document.getElementById("bangunan");
