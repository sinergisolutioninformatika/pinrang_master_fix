              ...
              <?php
                ...
                <form action="/pupr/jalan/destroy/{{$dataM->id}}" id="form{{$dataM->id}}" method="post">
                  <tr>
                    ...
                    <td nowrap>
                      <a href="/pupr/jalan/edit/{{$dataM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pupr/jalan/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="baik" class="col-md-4 col-form-label text-md-right">Kondisi Baik (km)</label>
                <div class="col-md-6">
                    <input id="baik" type="number" class="form-control" name="baik" value="{{$dataE->baik}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="sedang" class="col-md-4 col-form-label text-md-right">Kondisi Sedang</label>
                <div class="col-md-6">
                    <input id="sedang" type="number" class="form-control" name="sedang" value="{{$dataE->sedang}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="rusakringan" class="col-md-4 col-form-label text-md-right">Rusak Ringan</label>
                <div class="col-md-6">
                    <input id="rusakringan" type="number" class="form-control" name="rusakringan" value="{{$dataE->rusakringan}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="rusakberat" class="col-md-4 col-form-label text-md-right">Rusak Ringan</label>
                <div class="col-md-6">
                    <input id="rusakberat" type="number" class="form-control" name="rusakberat" value="{{$dataE->rusakberat}}" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                <label for="panjang" class="col-md-4 col-form-label text-md-right">Panjang Jalan</label>
                <div class="col-md-6">
                    <input id="panjang" type="number" class="form-control" name="panjang" value="{{$dataE->panjang}}" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
