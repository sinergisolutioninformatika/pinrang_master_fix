...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/parawisata/hotel/store" method="post">
            <div class="form-group row">
                <label for="jmlWisma" class="col-md-4 col-form-label text-md-right">Jumlah Wisma/Penginapan</label>
                <div class="col-md-6">
                    <input id="jmlWisma" type="number" class="form-control" name="jmlWisma" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlMelati1" class="col-md-4 col-form-label text-md-right">Hotel Melati 1</label>
                <div class="col-md-6">
                    <input id="jmlMelati1" type="number" class="form-control" name="jmlMelati1" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlMelati2" class="col-md-4 col-form-label text-md-right">Hotel Melati 2</label>
                <div class="col-md-6">
                    <input id="jmlMelati2" type="number" class="form-control" name="jmlMelati2" value="0">
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlMelati3" class="col-md-4 col-form-label text-md-right">Hotel Melati 3</label>
                <div class="col-md-6">
                    <input id="jmlMelati3" type="number" class="form-control" name="jmlMelati3" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="jmlHotel" type="number" class="form-control" name="jmlHotel" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
