 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkd/pegawaipendidikan/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="jmlSD" class="col-md-4 col-form-label text-md-right">Tamat SD</label>
                <div class="col-md-6">
                    <input id="jmlSD" type="number" class="form-control" name="jmlSD" value="{{$dataE->jmlSD}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlSMP" class="col-md-4 col-form-label text-md-right">Tamat SMP</label>
                <div class="col-md-6">
                    <input id="jmlSMP" type="number" class="form-control" name="jmlSMP" value="{{$dataE->jmlSMP}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlSMA" class="col-md-4 col-form-label text-md-right">Tamat SMA</label>
                <div class="col-md-6">
                    <input id="jmlSMA" type="number" class="form-control" name="jmlSMA" value="{{$dataE->jmlSMA}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlD1" class="col-md-4 col-form-label text-md-right">Diploma 1</label>
                <div class="col-md-6">
                    <input id="jmlD1" type="number" class="form-control" name="jmlD1" value="{{$dataE->jmlD1}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlD2" class="col-md-4 col-form-label text-md-right">Diploma 2</label>
                <div class="col-md-6">
                    <input id="jmlD2" type="number" class="form-control" name="jmlD2" value="{{$dataE->jmlD2}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlD3" class="col-md-4 col-form-label text-md-right">Diploma 3</label>
                <div class="col-md-6">
                    <input id="jmlD3" type="number" class="form-control" name="jmlD3" value="{{$dataE->jmlD3}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlS1" class="col-md-4 col-form-label text-md-right">Sarjana (S1)</label>
                <div class="col-md-6">
                    <input id="jmlS1" type="number" class="form-control" name="jmlS1" value="{{$dataE->jmlS1}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlS2" class="col-md-4 col-form-label text-md-right">Master (S2)</label>
                <div class="col-md-6">
                    <input id="jmlS2" type="number" class="form-control" name="jmlS2" value="{{$dataE->jmlS2}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlS3" class="col-md-4 col-form-label text-md-right">Doktor (S3)</label>
                <div class="col-md-6">
                    <input id="jmlS3" type="number" class="form-control" name="jmlS3" value="{{$dataE->jmlS3}}" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
