...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkd/golongan/store" method="post">
            <div class="form-group row">
                <label for="golI" class="col-md-4 col-form-label text-md-right">Golongan I</label>
                <div class="col-md-6">
                    <input id="golI" type="number" class="form-control" name="golI" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="golII" class="col-md-4 col-form-label text-md-right">Golongan II</label>
                <div class="col-md-6">
                    <input id="golII" type="number" class="form-control" name="golII" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="golIII" class="col-md-4 col-form-label text-md-right">Golongan III</label>
                <div class="col-md-6">
                    <input id="golIII" type="number" class="form-control" name="golIII" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="golIV" class="col-md-4 col-form-label text-md-right">Golongan IV</label>
                <div class="col-md-6">
                    <input id="golIV" type="number" class="form-control" name="golIV" value="0" autofocus>
                </div>
            </div>
            <hr>
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="totalGol" type="number" class="form-control" name="totalGol" value="0" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
