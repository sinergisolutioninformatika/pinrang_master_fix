 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkd/eselon/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="eselonIIa" class="col-md-4 col-form-label text-md-right">Eselon IIa</label>
                <div class="col-md-6">
                    <input id="eselonIIa" type="number" class="form-control" name="eselonIIa" value="{{$dataE->eselonIIa}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonIIb" class="col-md-4 col-form-label text-md-right">Eselon IIb</label>
                <div class="col-md-6">
                    <input id="eselonIIb" type="number" class="form-control" name="eselonIIb" value="{{$dataE->eselonIIb}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonIIIa" class="col-md-4 col-form-label text-md-right">Eselon IIIa</label>
                <div class="col-md-6">
                    <input id="eselonIIIa" type="number" class="form-control" name="eselonIIIa" value="{{$dataE->eselonIIIa}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonIIIb" class="col-md-4 col-form-label text-md-right">Eselon IIIb</label>
                <div class="col-md-6">
                    <input id="eselonIIIb" type="number" class="form-control" name="eselonIIIb" value="{{$dataE->eselonIIIb}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonIVa" class="col-md-4 col-form-label text-md-right">Eselon IVa</label>
                <div class="col-md-6">
                    <input id="eselonIVa" type="number" class="form-control" name="eselonIVa" value="{{$dataE->eselonIVa}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonIVb" class="col-md-4 col-form-label text-md-right">Eselon IVb</label>
                <div class="col-md-6">
                    <input id="eselonIVb" type="number" class="form-control" name="eselonIVb" value="{{$dataE->eselonIVb}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="eselonV" class="col-md-4 col-form-label text-md-right">Eselon V</label>
                <div class="col-md-6">
                    <input id="eselonV" type="number" class="form-control" name="eselonV" value="{{$dataE->eselonV}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="totalPejabat" class="col-md-4 col-form-label text-md-right">Jumlah Pejabat</label>
                <div class="col-md-6">
                    <input id="totalPejabat" type="number" class="form-control" name="totalPejabat" value="{{$dataE->totalPejabat}}" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
