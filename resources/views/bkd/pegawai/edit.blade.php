 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkd/pegawai/update/{{$kodeEdit}}" method="post">
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group row">
                <label for="totalLaki" class="col-md-4 col-form-label text-md-right">Laki-laki</label>
                <div class="col-md-6">
                    <input id="totalLaki" type="number" class="form-control" name="totalLaki" value="{{$dataE->totalLaki}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="totalPerempuan" class="col-md-4 col-form-label text-md-right">Perempuan</label>
                <div class="col-md-6">
                    <input id="totalPerempuan" type="number" class="form-control" name="totalPerempuan" value="{{$dataE->totalPerempuan}}" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="totalPegawai" class="col-md-4 col-form-label text-md-right">Jumlah Pegawai</label>
                <div class="col-md-6">
                    <input id="totalPegawai" type="number" class="form-control" name="totalPegawai" value="{{$dataE->totalPegawai}}" readonly>
                </div>
            </div>
        </div>{{ csrf_field() }}
