...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/bkd/pegawaiagama/store" method="post">
            <div class="form-group row">
                <label for="jmlIslam" class="col-md-4 col-form-label text-md-right">Islam</label>
                <div class="col-md-6">
                    <input id="jmlIslam" type="number" class="form-control" name="jmlIslam" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlKatolik" class="col-md-4 col-form-label text-md-right">Katolik</label>
                <div class="col-md-6">
                    <input id="jmlKatolik" type="number" class="form-control" name="jmlKatolik" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlProtestan" class="col-md-4 col-form-label text-md-right">Protestan</label>
                <div class="col-md-6">
                    <input id="jmlProtestan" type="number" class="form-control" name="jmlProtestan" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlBudha" class="col-md-4 col-form-label text-md-right">Budha</label>
                <div class="col-md-6">
                    <input id="jmlBudha" type="number" class="form-control" name="jmlBudha" value="0" autofocus>
                </div>
            </div>
            <div class="form-group row">
                <label for="jmlHindu" class="col-md-4 col-form-label text-md-right">Hindu</label>
                <div class="col-md-6">
                    <input id="jmlHindu" type="number" class="form-control" name="jmlHindu" value="0" autofocus>
                </div>
            </div>
        </div>{{ csrf_field() }}
        <div class="card-footer">
