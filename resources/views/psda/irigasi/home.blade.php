...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="irigasi/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  $nomor = 1;
                  foreach ($uptd as $dataU) {
                      ?>
                    <tr>
                      <td style="text-align: center;">{{$nomor}}</td>
                      <td nowrap>{{$dataU->nmaUPTD}}</td>
                      <td>
                        <input type="number" id="jmlTersier{{$nomor}}" class="form-control" name="jmlTersier{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlSekunder{{$nomor}}" class="form-control" name="jmlSekunder{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlInduk{{$nomor}}" class="form-control" name="jmlInduk{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlKuarter{{$nomor}}" class="form-control" name="jmlKuarter{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalTersier" class="form-control" name="totalTersier" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalSekunder" class="form-control" name="totalSekunder" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalInduk" class="form-control" name="totalInduk" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalKuarter" class="form-control" name="totalKuarter" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
