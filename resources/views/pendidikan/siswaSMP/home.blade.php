            ...
            <table class="table table-striped">
              ...
              <?php
                ...
                foreach ($dataA as $detA) {
                    ?>
                <form action="/pendidikan/siswaSMP/destroy/{{$detA->id}}" id="form{{$detA->id}}" method="post">
                  <tr>
                    <input type="hidden" name="siswaSMPMaster{{$detA->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$detA->ta}}</td>
                    <td style="text-align: center">{{$detA->totalSiswaSMP}}</td>
                    ...
                    <td>
                      ...
                      <a href="/pendidikan/siswaSMP/edit/{{$detA->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="siswaSMP/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  ...
                  foreach ($kecamatan as $xhc) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlSiswaSMP{{$nomor}}" class="form-control" name="jmlSiswaSMP{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalSiswaSMP" class="form-control" name="totalSiswaSMP" value="0" readonly>
                   </td>
                   <td>
    ...
    $("#jmlLaki{{$nopu}}").keyup(function() {
      ...
      <?php
        ...
        <?php
          $nojk = 1;
          foreach ($kecamatan as $pk){ ?>
            td = td + Number($("#jmlSiswaSMP{{$nojk}}").val());
        <?php
          $nojk ++;
          } ?>
          $("#totalSiswaSMP").val(td);
      });
