...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="kondisiSMP/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  $nomor = 1;
                  foreach ($kecamatan as $xkSMP) {
                      ?>
                    <tr>
                      <td>{{$nomor}}</td>
                      <td nowrap>{{$xkSMP->nmaKecamatan}}</td>
                      <td>
                        <input type="number" id="jmlSMP{{$nomor}}" class="form-control" name="jmlSMP{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalSMP" class="form-control" name="totalSMP" value="0" readonly>
                   </td>
                   <td>
