...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="kondisiPAUD/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  $nomor = 1;
                  foreach ($kecamatan as $xkPAUD) {
                      ?>
                    <tr>
                      <td>{{$nomor}}</td>
                      <td nowrap>{{$xkPAUD->nmaKecamatan}}</td>
                      <td>
                        <input type="number" id="jmlPAUD{{$nomor}}" class="form-control" name="jmlPAUD{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalPAUD" class="form-control" name="totalPAUD" value="0" readonly>
                   </td>
                   <td>
  ...
  function showUser(str) {
      if (str == "") {
          ...
          xmlhttp.open("GET","/modals/pendidikan/getkondisiPAUD.php?q="+str,true);
          xmlhttp.send();
      }
  }
  </script>
