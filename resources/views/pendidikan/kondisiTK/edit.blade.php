 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pendidikan/kondisiTK/update/{{$id}}" method="post">
              ...
              <input type="hidden" name="_method" value="PUT">
                <?php
                  ...
                  foreach ($dataD as $detailX) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlTK{{$nomor}}" class="form-control" name="jmlTK{{$nomor}}" value="{{$detailX->jmlTK}}" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalTK" class="form-control" name="totalTK" value="{{$totTK}}" readonly>
                   </td>
                   <td>
