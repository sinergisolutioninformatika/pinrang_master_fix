                ...
                <form action="/pendidikan/siswaSD/destroy/{{$detA->id}}" id="form{{$detA->id}}" method="post">
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="/pendidikan/siswaSD/edit/{{$detA->id}}"><img src="/image/edit.png" alt=""></a>
...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="siswaSD/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  ...
                  foreach ($kecamatan as $xhc) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlSiswaSD{{$nomor}}" class="form-control" name="jmlSiswaSD{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalSiswaSD" class="form-control" name="totalSiswaSD" value="0" readonly>
                   </td>
                   <td>
