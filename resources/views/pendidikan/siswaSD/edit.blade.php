            ...
            <table class="table table-striped">
              ...
              <?php
                ...
                foreach ($dataM as $detM) {
                    ?>
                <form action="/pendidikan/siswaSD/destroy/{{$detM->id}}" id="form{{$detM->id}}" method="post">
                  <tr>
                    <input type="hidden" name="siswaSDMaster{{$detM->id}}" value="">
                    <td>{{$nomor}}</td>
                    <td>{{$detM->ta}}</td>
                    <td style="text-align: center">{{$detM->totalSiswaSD}}</td>
                    ...
                    <td>
                      ...
                      <a href="/pendidikan/siswaSD/edit/{{$detM->id}}"><img src="/image/edit.png" alt=""></a>
 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/pendidikan/siswaSD/update/{{$id}}" method="post">
              ...
              <input type="hidden" name="_method" value="PUT">
                <?php
                  ...
                  foreach ($dataD as $detailX) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlSiswaSD{{$nomor}}" class="form-control" name="jmlSiswaSD{{$nomor}}" value="{{$detailX->jmlSiswaSD}}" readonly>
                      </td>
                      <td>
                ...
                <?php
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalSiswaSD" class="form-control" name="totalSiswaSD" value="{{$totSMP}}" readonly>
                   </td>
                   <td>
    ...
    $("#jmlLaki{{$nopu}}").keyup(function() {
      ...
      <?php
        ...
        <?php
          $nojk = 1;
          foreach ($kecamatan as $pk){ ?>
            thetotalSiswaSD = thetotalSiswaSD + Number($("#jmlSiswaSD{{$nojk}}").val());
        <?php
          $nojk ++;
          } ?>
          $("#totalSiswaSD").val(thetotalSiswaSD);
      });
