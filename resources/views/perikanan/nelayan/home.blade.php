...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perikanan/nelayan/store" method="post">
                ...
                <?php
                  ...
                  foreach ($dataKecamatan as $dataK) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlNelayan{{$nomor}}" class="form-control" name="jmlNelayan{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                        <input type="number" id="jmlNelayanlaut{{$nomor}}" class="form-control" name="jmlNelayanlaut{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlNelayandarat{{$nomor}}" class="form-control" name="jmlNelayandarat{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlPetanisawah{{$nomor}}" class="form-control" name="jmlPetanisawah{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlPetanikolam{{$nomor}}" class="form-control" name="jmlPetanikolam{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlPetanitambak{{$nomor}}" class="form-control" name="jmlPetanitambak{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalNelayan" class="form-control" name="totalNelayan" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalNelayanlaut" class="form-control" name="totalNelayanlaut" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalNelayandarat" class="form-control" name="totalNelayandarat" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPetanisawah" class="form-control" name="totalPetanisawah" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPetanikolam" class="form-control" name="totalPetanikolam" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPetanitambak" class="form-control" name="totalPetanitambak" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
