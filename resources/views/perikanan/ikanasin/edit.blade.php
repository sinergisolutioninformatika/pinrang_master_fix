 ...
 ?>
    ...
    <div class="collapse show" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perikanan/ikanasin/update/{{$kodeEdit}}" method="post">
                ...
                <?php
                  ...
                  foreach ($dataDetail as $dataD) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlDarat{{$nomor}}" class="form-control" name="jmlDarat{{$nomor}}" value="{{$dataD->jmlDarat}}">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td>
                     <input type="number" id="totalDarat" class="form-control" name="totalDarat" value="{{$dataE->totalDarat}}" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
