...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perikanan/armada/store" method="post">
                ...
                <?php
                  ...
                  foreach ($dataKecamatan as $dataK) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlArmada{{$nomor}}" class="form-control" name="jmlArmada{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
                        <input type="number" id="jmlKapalmotor{{$nomor}}" class="form-control" name="jmlKapalmotor{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlPerahumotor{{$nomor}}" class="form-control" name="jmlPerahumotor{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlPerahutanpamotor{{$nomor}}" class="form-control" name="jmlPerahutanpamotor{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td><b>Total</b></td>
                   <td>
                     <input type="number" id="totalArmada" class="form-control" name="totalArmada" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalKapalmotor" class="form-control" name="totalKapalmotor" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPerahumotor" class="form-control" name="totalPerahumotor" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalPerahutanpamotor" class="form-control" name="totalPerahutanpamotor" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
