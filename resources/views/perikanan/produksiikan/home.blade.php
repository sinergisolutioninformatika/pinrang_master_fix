...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perikanan/produksiikan/store" method="post">
                ...
                <?php
                  ...
                  foreach ($dataKecamatan as $dataK) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" id="jmlRawa{{$nomor}}" class="form-control" name="jmlRawa{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlSungai{{$nomor}}" class="form-control" name="jmlSungai{{$nomor}}" value="0">
                      </td>
                      <td>
                        <input type="number" id="jmlWaduk{{$nomor}}" class="form-control" name="jmlWaduk{{$nomor}}" value="0">
                      </td>
                    </tr>
                <?php
                  $nomor ++;
                 ...
                 <tr>
                   ...
                   <td>
                     <input type="number" id="totalRawa" class="form-control" name="totalRawa" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalSungai" class="form-control" name="totalSungai" value="0" readonly>
                   </td>
                   <td>
                     <input type="number" id="totalWaduk" class="form-control" name="totalWaduk" value="0" readonly>
                   </td>
                 </tr>
                 {{csrf_field()}}
              </table>
