...
<br>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-group" action="/perpusarsip/kunjungan/store" method="post">
            <table class="table table-striped table-hover">
                ...
                <?php
                  $nomor = 1;
                  foreach ($dataLokasi as $dataL) {
                      ?>
                    <tr>
                      <td style="text-align: center">{{$nomor}}</td>
                      <td nowrap>{{$dataL->nmaLokasi}}</td>
                      <td>
                        <input type="number" id="jmlKunjungan{{$nomor}}" class="form-control" name="jmlKunjungan{{$nomor}}" value="0" readonly>
                      </td>
                      <td>
